    ...
    <section id='product' className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={styles.paragraph + ' max-w-[470px] mt-5'}>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut omnis eaque asperiores odio eius unde quisquam quam at totam eum. Recusandae qui architecto nesciunt libero ratione, reprehenderit totam temporibus non.
        </p>
